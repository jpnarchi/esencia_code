...
export function GlobeDemo() {
  const globeConfig = {
    pointSize: 4,
    globeColor: "#FF8C00", // Changed to dark orange
    showAtmosphere: true,
    atmosphereColor: "#FFA500", // Changed to orange
    atmosphereAltitude: 0.1,
    emissive: "#FF8C00", // Changed to dark orange
    emissiveIntensity: 0.1,
    shininess: 0.9,
    polygonColor: "rgba(0,0,0,0.8)", // Changed to black with transparency
    ambientLight: "#FFA500", // Changed to orange
    directionalLeftLight: "#FFD700", // Changed to golden orange
    directionalTopLight: "#FFD700", // Changed to golden orange
    pointLight: "#FFD700", // Changed to golden orange
    arcTime: 1000,
    arcLength: 0.9,
    rings: 1,
    maxRings: 3,
  ...
  const colors = ["#FF8C00", "#FFA500", "#FFD700"]; // Changed to orange tones
  const sampleArcs = [
    {
      order: 1,
      startLat: -19.885592,
